                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3 form-check">
                                            <input type="checkbox" value="1" name="is-home" class="form-check-input" id="isHome">
                                    ...
                                    <span class="js-span-toggle-content">
                                        ...
                                        <div class="tool-content">
                                            <div class="row" id="row1">
                                                <input type="hidden" name="inputFile" value="inputType[]">
                                                <div class="col-md-3 mb-3">
                                                    <input type="text" name="contentKey[]" class="form-control" value
                                                        placeholder="Key">
                                                </div>
                                                <div class="col-md-9 mb-3">
                                                    <input type="text" name="contentValue[]" class="form-control" value
                                                        placeholder="Value">
                                                </div>
                                            </div>
                                        </div>
